...
if ... ~= "__ar-assets-api__.icons" then
    return require("__ar-assets-api__.icons")
end
...
local _icons = {
    ---@type Reskins.Api.Icons.Pipes
    pipes = require("__ar-assets-api__.icons.pipes"),
}
...
local function is_icon_using_reskins_images(icon_datum)
    return icon_datum and icon_datum.icon:find("__ar%-assets%-") ~= nil
end
...
---
---### Parameters
---@param deferred_icons { [Reskins.Api.Defines.Stage]: (DeferrableIconData|DeferrableIconDatum)[] } # The dictionary of deferrable icons, indexed by stage, to add the deferrable icon to.
---@param stage Reskins.Api.Defines.Stage # The key to the data stage to store the deferrable icon in.
...
---
---### See Also
---@see Reskins.Api.Icons.assign_icons_to_prototype_and_related_prototypes
...
---
---### Parameters
---@param deferred_icons { [Reskins.Api.Defines.Stage]: (DeferrableIconData|DeferrableIconDatum)[] } # The dictionary of deferrable icons, indexed by stage, to assign the deferrable icons from.
---@param stage Reskins.Api.Defines.Stage # The index of the data stage to source deferrable icons from.
---
---### Exceptions
---*@throws* `string` — Thrown when a deferred icon's `name` field is `nil` or an empty string.<br/>
---*@throws* `string` — Thrown when a deferred icon's `type_name` field is `nil` or an empty string.<br/>
...
---
---### See Also
---@see Reskins.Api.Icons.store_icon_for_deferred_assigment_in_stage
---@see Reskins.Api.Icons.assign_deferrable_icon
...
---
---### See Also
---@see Reskins.Api.Icons.add_missing_icon_defaults
---@nodiscard
...
---
---### See Also
---@see Reskins.Api.Icons.add_missing_icons_defaults
---@see Reskins.Api.Icons.get_icon_from_prototype_by_reference
---@nodiscard
...
---
---### See Also
---@see Reskins.Api.Icons.add_icons_from_prototype_to_icons_by_reference
---@nodiscard
...
---@see Reskins.Api.Icons.add_missing_icons_defaults
---@see Reskins.Api.Icons.add_missing_icon_defaults
---@see Reskins.Api.Icons.get_icon_from_prototype_by_name
---@nodiscard
...
function _icons.get_symbol(symbol, tint)
    ...
    local icon_data = {
        {
            icon = "__ar-assets-api__/graphics/icons/symbols/" .. symbol:lower() .. "-symbol.png",
            icon_size = 64,
            icon_mipmaps = 4,
            scale = 0.5,
        },
...
function _icons.get_letter(letter, tint)
    ...
    local icon_data = {
        {
            icon = "__ar-assets-api__/graphics/icons/letters/letter-" .. letter:lower() .. ".png",
            icon_size = 64,
            icon_mipmaps = 4,
            scale = 0.5,
        },
...
function _icons.get_equipment_icon_background(category)
    ...
    ---@type data.IconData
    local icon_data = {
        icon = "__ar-assets-api__/graphics/icons/backgrounds/equipment-background.png",
        icon_size = 64,
        icon_mipmaps = 4,
        scale = 0.5,
        tint = tint,
