...
if ... ~= "__ar-assets-api__.api.sprites" then
    return require("__ar-assets-api__.api.sprites")
end
...
---### Examples
---```lua
---local _sprites = require("__ar-assets-api__.api.sprites")
---```
---@class Reskins.Api.Sprites
local _sprites = {
    ---@type Reskins.Api.Sprites.Belts
    belts = require("__ar-assets-api__.api.sprites.belts"),

    ---@type Reskins.Api.Sprites.ChemicalPlants
    chemical_plants = require("__ar-assets-api__.api.sprites.chemical-plants"),

    ---@type Reskins.Api.Sprites.Pipes
    pipes = require("__ar-assets-api__.api.sprites.pipes"),
}

---@type Reskins.Api.Icons
local _icons = require("__ar-assets-api__.api.icons")
...
function _sprites.get_sprite_light_layer(light_name, tint)
    ...
    local sprite = {
        flags = { "light" },
        draw_as_light = true,
        filename = "__ar-assets-api__/graphics/icons/lights/" .. light_name .. "-light.png",
        size = 64,
        mipmap_count = 4,
        scale = 0.25,
        tint = tint,
