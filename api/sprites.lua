...
---```
---@throws Thrown when `directory` is not a non-empty string.
---@throws Thrown when `sprite_name` is not a non-empty string.
---@throws Thrown when `num_variations` is not a positive integer.
---@throws Thrown when `is_light` is not a boolean.
---@throws Thrown when `tint` is not a `Color`.
---@nodiscard
