...
if ... ~= "__ar-assets-api__.api.version" then
    return require("__ar-assets-api__.api.version")
end
...
---### Examples
---```lua
---local _version = require("__ar-assets-api__.api.version")
---```
---@class Reskins.Api.Version
local _version = {}
