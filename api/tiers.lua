...
if ... ~= "__ar-assets-api__.api.tiers" then
    return require("__ar-assets-api__.api.tiers")
end
...
---### Examples
---```lua
---local _tiers = require("__ar-assets-api__.api.tiers")
---```
...
local _settings = require("__ar-assets-api__.api.settings")
...
local function is_icon_tier_labeled(icon_datum)
    return icon_datum and icon_datum.icon:find("__ar-assets-api__%/graphics%/icons%/tiers%/") ~= nil
end
...
function _tiers.add_tier_labels_to_icons(tier, icon_data)
    ...
    if tier > 0 then
        ...
        local icon_file_name = "__ar-assets-api__/graphics/icons/tiers/" .. labeling_style .. "/" .. tier .. ".png"
