...
if ... ~= "__ar-assets-api__.api.prototypes" then
    return require("__ar-assets-api__.api.prototypes")
end
...
---### Examples
---```lua
---local _prototypes = require("__ar-assets-api__.api.prototypes")
---```
---@class Reskins.Api.Prototypes
local _prototypes = {}
...
---Rescales the given `prototype` by the given `scalar`.
---
...
---
---### See Also
---@see Reskins.Api.Prototypes.rescale_prototype
