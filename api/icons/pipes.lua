...
if ... ~= "__ar-assets-api__.api.icons.pipes" then
    return require("__ar-assets-api__.api.icons.pipes")
end
...
---### Examples
---```lua
---local _icons = require("__ar-assets-api__.api.icons.pipes")
---```
---@class Reskins.Api.Icons.Pipes
local _pipes = {}
...
---path = "__ar-assets-api__/graphics/icons/common/pipe/iron"
---```
---
---### Parameters
...
local function get_path_to_pipe_material_icons(folder_name, material_type)
    ...
    if material_type == "iron" then
        path = "__ar-assets-api__/graphics/icons/common/" .. folder_name .. "/iron"
    elseif material_type:find("angels") then
        path = "__ar-assets-angels__/graphics/icons/smelting/" .. folder_name .. "/" .. material_type:gsub("angels%-", "")
    else
        path = "__ar-assets-bobs__/graphics/icons/logistics/" .. folder_name .. "/" .. material_type
    end
