...
if ... ~= "__ar-assets-api__.api.sprites.pipes" then
    return require("__ar-assets-api__.api.sprites.pipes")
end
...
---### Examples
---```lua
---local _sprites = require("__ar-assets-api__.api.sprites.pipes")
---```
---@class Reskins.Api.Sprites.Pipes
local _pipes = {}
...
function _pipes.get_vertical_pipe_shadow(shift)
    ...
    local shadow_animation = {
        filename = "__ar-assets-api__/graphics/entity/common/pipe-patches/vertical-pipe-shadow-patch.png",
        priority = "high",
        width = 64,
        height = 64,
        repeat_count = 36,
        ...
        shift = shift,
        hr_version = {
            filename = "__ar-assets-api__/graphics/entity/common/pipe-patches/hr-vertical-pipe-shadow-patch.png",
            priority = "high",
            width = 128,
            height = 128,
            repeat_count = 36,
...
---path = "__ar-assets-api__/graphics/entity/common/pipe/iron/"
---```
---
---### Parameters
...
local function get_path_to_pipe_material_sprites(folder_name, material_type)
    ...
    if material_type == "iron" then
        path = "__ar-assets-api__/graphics/entity/common/" .. folder_name .. "/iron/"
    ...
    local pipe_pictures = {
        straight_vertical_single = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-straight-vertical-single-shadow.png",
                    priority = "extra-high",
                    width = 80,
                    height = 80,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-straight-vertical-single-shadow.png",
                        priority = "extra-high",
                        width = 160,
                        height = 160,
                        draw_as_shadow = true,
        ...
        straight_vertical = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-straight-vertical-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-straight-vertical-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        straight_horizontal_window = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-straight-horizontal-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-straight-horizontal-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        corner_up_right = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-corner-up-right-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-corner-up-right-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        corner_up_left = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-corner-up-left-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-corner-up-left-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        corner_down_right = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-corner-down-right-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-corner-down-right-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        corner_down_left = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-corner-down-left-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-corner-down-left-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        t_up = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-t-up-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-t-up-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        t_down = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-t-down-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-t-down-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        t_right = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-t-right-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-t-right-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        t_left = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-t-left-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-t-left-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        cross = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-cross-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-cross-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        ending_up = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-ending-up-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-ending-up-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        ending_down = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-ending-down-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-ending-down-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        ending_right = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-ending-right-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-ending-right-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        ending_left = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/pipe-ending-left-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe/shadows/hr-pipe-ending-left-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
    ...
    local pipe_to_ground_pictures = {
        up = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/pipe-to-ground-up-shadow.png",
                    priority = "high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/hr-pipe-to-ground-up-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        down = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/pipe-to-ground-down-shadow.png",
                    priority = "high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/hr-pipe-to-ground-down-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        left = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/pipe-to-ground-left-shadow.png",
                    priority = "high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/hr-pipe-to-ground-left-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
        ...
        right = {
            layers = {
                ...
                -- Shadows
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/pipe-to-ground-right-shadow.png",
                    priority = "high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-to-ground/shadows/hr-pipe-to-ground-right-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        draw_as_shadow = true,
    ...
    local pipe_cover_pictures = {
        north = {
            layers = {
                ...
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/pipe-cover-north-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/hr-pipe-cover-north-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        scale = 0.5,
        ...
        east = {
            layers = {
                ...
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/pipe-cover-east-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/hr-pipe-cover-east-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        scale = 0.5,
        ...
        south = {
            layers = {
                ...
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/pipe-cover-south-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/hr-pipe-cover-south-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        scale = 0.5,
        ...
        west = {
            layers = {
                ...
                {
                    filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/pipe-cover-west-shadow.png",
                    priority = "extra-high",
                    width = 64,
                    height = 64,
                    draw_as_shadow = true,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/pipe-covers/shadows/hr-pipe-cover-west-shadow.png",
                        priority = "extra-high",
                        width = 128,
                        height = 128,
                        scale = 0.5,
