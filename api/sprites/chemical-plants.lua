...
if ... ~= "__ar-assets-api__.api.sprites.chemical-plants" then
    return require("__ar-assets-api__.api.sprites.chemical-plants")
end
...
---### Examples
---```lua
---local _sprites = require("__ar-assets-api__.api.sprites.chemical-plants")
---```
---@class Reskins.Api.Sprites.ChemicalPlants
...
function _chemical_plants.get_standard_animation(tint)
    return reskins.lib.sprites.make_4way_animation_from_spritesheet({
            layers = {
                -- Base
                {
                    filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/chemical-plant-base.png",
                    width = 108,
                    height = 148,
                    frame_count = 24,
                    line_length = 12,
                    ...
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/hr-chemical-plant-base.png",
                        width = 220,
                        height = 292,
                        frame_count = 24,
                        line_length = 12,
                ...
                -- Mask
                {
                    filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/chemical-plant-mask.png",
                    width = 108,
                    height = 148,
                    frame_count = 24,
                    line_length = 12,
                    ...
                    tint = tint,
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/hr-chemical-plant-mask.png",
                        width = 220,
                        height = 292,
                        frame_count = 24,
                        line_length = 12,
                ...
                -- Highlights
                {
                    filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/chemical-plant-highlights.png",
                    width = 108,
                    height = 148,
                    frame_count = 24,
                    line_length = 12,
                    ...
                    hr_version = {
                        filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/hr-chemical-plant-highlights.png",
                        width = 220,
                        height = 292,
                        frame_count = 24,
                        line_length = 12,
...
function _chemical_plants.get_standard_remnants(tint)
    ...
    local animation = {
        layers = {
            -- Base
            {
                filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/remnants/chemical-plant-remnants-base.png",
                line_length = 1,
                width = 224,
                height = 172,
                frame_count = 1,
                ...
                hr_version = {
                    filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/remnants/hr-chemical-plant-remnants-base.png",
                    line_length = 1,
                    width = 446,
                    height = 342,
                    frame_count = 1,
            ...
            -- Mask
            {
                filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/remnants/chemical-plant-remnants-mask.png",
                line_length = 1,
                width = 224,
                height = 172,
                frame_count = 1,
                ...
                tint = tint,
                hr_version = {
                    filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/remnants/hr-chemical-plant-remnants-mask.png",
                    line_length = 1,
                    width = 446,
                    height = 342,
                    frame_count = 1,
            ...
            -- Highlights
            {
                filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/remnants/chemical-plant-remnants-highlights.png",
                line_length = 1,
                width = 224,
                height = 172,
                frame_count = 1,
                ...
                blend_mode = reskins.lib.settings.blend_mode, -- "additive",
                hr_version = {
                    filename = "__ar-assets-api__/graphics/entity/common/chemical-plant/remnants/hr-chemical-plant-remnants-highlights.png",
                    line_length = 1,
                    width = 446,
                    height = 342,
                    frame_count = 1,
